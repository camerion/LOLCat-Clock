...
if (time == partyTime){
	...
	image = "https://i.pinimg.com/originals/99/57/93/99579357ff3aff9bb8cc9fe4a978e511.jpg";
    messageText = "IZ NOM NOM NOM TIME!!";
} else if (time == wakeUpTime) {
	image="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSGvwkmll_gKI_HMNXkocFFe-iiNCDV-P1Gww&usqp=CAU";
	messageText = "IZ TIME TO GETTUP.";
} else if (time < noon) {
	image="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQhC-AtfKVyj6P7elEBzIA1ywpEN_m-J8xlug&usqp=CAU";
...
var partyEvent = function()
{
	if (isPartyTime === false){
		isPartyTime = true;
		time = partyTime;
		partyTimeButton.innerText = "Party Time!"; //button text
		partyTimeButton.style.backgroundColor = "#222"; //Bonus
	} else {
		isPartyTime = false;
